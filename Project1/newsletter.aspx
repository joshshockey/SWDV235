...
<script runat="server">
    protected void submitButton_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            // Create command 
            comm = new SqlCommand("EXEC InsertNews @emailTextBox", conn);           
    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
		...
		<div class="inner cover">
            <h1 class="cover-heading">To keep up to date on all the live shows and debauchery, plug your email into the form below!</h1>          
           
			<div class="container">
			<div class="row">
				<div class="span12">
					<div class="thumbnail center well well-small text-center">
						<h2>Subscribe to our weekly Newsletter and stay tuned.</h2>              					                
					 <%--Form code ammended to accomodate asp--%>
